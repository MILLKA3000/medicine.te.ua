...
-o-transform:rotate(90deg);'> 
	...
	echo"<br>Адреса: ".$_SESSION['adress']."
	<br> Дільниця  <input size='2'  type='text' value=''> &nbsp&nbsp&nbsp Дата та час прийому ".date_parse_vupuska($time[0]['date'])." &nbsp&nbsp&nbsp ".$time[0]['timebegin']." - ".$time[0]['timeend']." <br>
    ----------------------------(".$name_spec.")  ".$family." ".$name." ".$third_name."<br>
    Флю: <input size='6'  type='text' value=''> &nbsp&nbsp Онк: <input size='6'  type='text' value=''> &nbsp&nbsp ЕКГ: <input size='6'  type='text' value=''> &nbsp&nbsp АТ: <input size='6'  type='text' value=''>
	 <br><br></div>"; 
