...
//місяць дня
 ...
 /* $dayofmonth=date("t",mktime($t_start->format('t'));
  ...
  echo "<center ><br><FONT size=8>Запис паціента на метод обстеження</FONT><br><br>
		";

  if ($_GET['m']==1){echo "<a href='zap_calendar.php?doctor=".$_GET['doctor']."&m=".($_GET['m'])."' ><img src='images/calendar/prev.jpeg'></a>";}
  else {echo "<a href='zap_calendar.php?doctor=".$_GET['doctor']."&m=".($_GET['m']-1)."' ><img src='images/calendar/prev.jpeg'></a>";}
  echo "<b><FONT size='14' color='gray'>".$num_mis[$misjac-1]."  </FONT></b>";
  if ($_GET['m']==12){echo "<a href='zap_calendar.php?doctor=".$_GET['doctor']."&m=".($_GET['m'])."' ><img src='images/calendar/next.jpeg'></a>";}
  else
  {echo "<a href='zap_calendar.php?doctor=".$_GET['doctor']."&m=".($_GET['m']+1)."' ><img src='images/calendar/next.jpeg'></a>";}
			...
			(($mas_cshedule[$sch]['date'][8].$mas_cshedule[$sch]['date'][9]<=$n)&&($mas_cshedule[$sch]['date'][5].$mas_cshedule[$sch]['date'][6]>date('m'))))
				{
						...
						{
							echo "<center><div class='text'><b><a href='zapus.php?patient=".$mas_cshedule[$sch]['id']."'>".$start." - ".$end." </a><br>";
						}
					else 
						if ($mas_cshedule[$sch]['patient_id']>1)
						{
