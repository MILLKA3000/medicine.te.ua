<center><b><font color='green'>Новий звіт</font></b></center>
...
echo"<table><tr><td><b>Дата</b></td> <td><input  id='inputDate4' name='date' value='".date("Y-m-d")."' /></td></tr>";
...
$('.zwit_lik').change(function() {
            ...
            window.location.href='zwit.php?new=active&hosp='+ encodeURIComponent($('select[name=\'zwit_lik\']').val());
