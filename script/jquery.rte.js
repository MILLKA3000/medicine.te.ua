...
jQuery.fn.rte = function(css_url, media_url) {
    ...
    function formatTextadd(iframe, command) {
       
            iframe.append(command);
    ...
    function disableDesignMode(iframe, submit) {
        ...
        if(submit==true)
            ...
            var textarea = $('<textarea cols="80" rows="10"></textarea>');
    ...
    function toolbar(iframe) {
        ...
        var tb = $("<div class='rte-toolbar' id='toolbar-"+iframe.title+"'><div>\
            ...
            <p>\
                <a href='#' class='bold'><img src='../toolbox/images/bold.gif' alt='bold' /></a>\
                <a href='#' class='italic'><img src='../toolbox/images/italic.gif' alt='italic' /></a>\
            </p>\
            <p>\
                <a href='#' class='unorderedlist'><img src='../toolbox/images/unordered.gif' alt='unordered list' /></a>\
                <a href='#' class='link'><img src='../toolbox/images/link.png' alt='link' /></a>\
                <a href='#' class='image'><img src='../toolbox/images/image.png' alt='image' /></a>\
                <a href='#' class='disable'><img src='../toolbox/images/close.gif' alt='close rte' /></a>\
				<a href='#' class='menu0' style='font-size:10pt;margin-left:40px;'>Звіт про лікаря</a>\
				<a href='#' class='menu1' style='font-size:10pt;margin-left:40px;'>Немає графіка</a>\
				<a href='#' class='menu2' style='font-size:10pt;margin-left:40px;'>Немає фото</a>\
            </p></div></div>");
		...
		$('.menu0', tb).click(function(){ iframe.contentWindow.document.write('<b><center>  Звіт про лікаря </center></b>');});
		 $('.menu1', tb).click(function(){ iframe.contentWindow.document.write('<b> - Немає графіка</b><br>');});
		 $('.menu2', tb).click(function(){ iframe.contentWindow.document.write('<b> - Немає фото</b><br>');});
